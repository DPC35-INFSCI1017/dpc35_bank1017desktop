...
public class DbUtilities {
    ...
    private String dbName = "dpc35_bank1017"; // default database name
    private String dbUserName = "dpc35"; // login name for the database server
    private String dbPassword = "1125049"; // password for the database server
